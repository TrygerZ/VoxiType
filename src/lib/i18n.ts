...
const id: Dict = {
  ...
  "settings.general.widget_auto_hide": "Sembunyikan widget otomatis",
  "settings.general.widget_auto_hide.desc": "Sembunyikan widget saat tidak aktif (3-60 detik, 0 untuk nonaktif).",
  "settings.general.widget_auto_hide.seconds": "detik",
  "settings.general.widget_auto_hide.seconds_label": "Durasi sembunyikan otomatis dalam detik",
  "settings.general.system": "Sistem",
  "settings.general.storage": "Penyimpanan data",
  "settings.general.onboarding": "Setup awal",
  "settings.general.onboarding.desc": "Jalankan kembali panduan setup VoxiType.",
  "settings.general.onboarding.button": "Ulangi setup",
  ...
  "onboarding.steps.label.microphone": "Mikrofon",
  "onboarding.steps.label.stt": "Transkripsi",
  "onboarding.steps.label.data_directory": "Data",
  "onboarding.steps.label.hotkey": "Pintasan",
  "onboarding.steps.label.smoke_test": "Uji suara",
  "onboarding.steps.label.complete": "Selesai",
  "onboarding.smoke_test.title": "Coba dikte Anda",
  "onboarding.smoke_test.body": "Tekan {key}, lalu ucapkan sesuatu. Hasil transkripsi akan muncul di sini.",
  "onboarding.smoke_test.waiting": "Menunggu transkripsi...",
  "onboarding.smoke_test.success": "Transkripsi berhasil",
  "onboarding.smoke_test.continue": "Lanjut",
  "onboarding.smoke_test.error": "Transkripsi gagal: {message}.",
  "onboarding.smoke_test.troubleshoot": "Periksa mikrofon, hotkey, dan konfigurasi mesin transkripsi.",
  "onboarding.smoke_test.timeout": "Belum ada hasil. Pastikan hotkey aktif, mikrofon terhubung, lalu coba lagi.",
  "onboarding.back": "Kembali",
  "onboarding.skip": "Lewati",
  "onboarding.microphone.title": "Pilih mikrofon",
  "onboarding.microphone.body": "Pilih mikrofon yang akan digunakan untuk dikte. Anda dapat mengubahnya nanti di Pengaturan.",
  "onboarding.microphone.select": "Mikrofon",
  "onboarding.microphone.level": "Level suara",
  "onboarding.microphone.none": "Tidak ada mikrofon ditemukan atau izin mikrofon ditolak.",
  "onboarding.microphone.continue": "Simpan & lanjut",
  ...
  "data_directory.title": "Pilih folder data",
  "data_directory.body": "Opsional: pindahkan riwayat, kamus, dan pengaturan lokal VoxiType ke folder lain.",
  "data_directory.active": "Lokasi aktif",
  "data_directory.preview": "Preview lokasi baru",
  "data_directory.loading": "Memuat lokasi...",
  "data_directory.choose": "Pilih folder...",
  "data_directory.apply": "Terapkan",
  ...
  "data_directory.restart_now": "Restart sekarang",
...
const en: Dict = {
  ...
  "settings.general.widget_auto_hide": "Auto-hide widget",
  "settings.general.widget_auto_hide.desc": "Hide widget when idle (3-60 seconds, 0 to disable).",
  "settings.general.widget_auto_hide.seconds": "seconds",
  "settings.general.widget_auto_hide.seconds_label": "Auto-hide duration in seconds",
  "settings.general.system": "System",
  "settings.general.storage": "Data storage",
  "settings.general.onboarding": "Initial setup",
  "settings.general.onboarding.desc": "Run the VoxiType setup guide again.",
  "settings.general.onboarding.button": "Run setup again",
  ...
  "onboarding.steps.label.microphone": "Microphone",
  "onboarding.steps.label.stt": "Transcription",
  "onboarding.steps.label.data_directory": "Data",
  "onboarding.steps.label.hotkey": "Hotkey",
  "onboarding.steps.label.smoke_test": "Voice test",
  "onboarding.steps.label.complete": "Done",
  "onboarding.smoke_test.title": "Try your dictation",
  "onboarding.smoke_test.body": "Press {key}, then say something. Your transcription will appear here.",
  "onboarding.smoke_test.waiting": "Waiting for transcription...",
  "onboarding.smoke_test.success": "Transcription received",
  "onboarding.smoke_test.continue": "Continue",
  "onboarding.smoke_test.error": "Transcription failed: {message}.",
  "onboarding.smoke_test.troubleshoot": "Check your microphone, hotkey, and transcription engine settings.",
  "onboarding.smoke_test.timeout": "No result yet. Make sure the hotkey and microphone work, then try again.",
  "onboarding.back": "Back",
  "onboarding.skip": "Skip",
  "onboarding.microphone.title": "Choose a microphone",
  "onboarding.microphone.body": "Choose the microphone used for dictation. You can change it later in Settings.",
  "onboarding.microphone.select": "Microphone",
  "onboarding.microphone.level": "Audio level",
  "onboarding.microphone.none": "No microphone found or microphone permission was denied.",
  "onboarding.microphone.continue": "Save & continue",
  // Welcome how-it-works (heuristic: match real world + aesthetic)
  ...
  "data_directory.title": "Choose data folder",
  "data_directory.body": "Optional: move VoxiType history, dictionary, and local settings to another folder.",
  "data_directory.active": "Active location",
  "data_directory.preview": "New location preview",
  "data_directory.loading": "Loading location...",
  "data_directory.choose": "Choose folder...",
  "data_directory.apply": "Apply",
  ...
  "data_directory.restart_now": "Restart now",
