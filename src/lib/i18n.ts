...
const id: Dict = {
  ...
  "onboarding.complete.body": "Tekan {key} untuk mulai mendikte. Tambahkan Groq API key di Pengaturan untuk transkripsi cloud.",
...
const en: Dict = {
  ...
  "onboarding.complete.body": "Press {key} to start dictating. Add your Groq API key in Settings for cloud transcription.",
